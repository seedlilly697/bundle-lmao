const omnidirectionalBridgeConveyor = extendContent(BufferedItemBridge, "omnidirectional-bridge-conveyor", {
    ...
    canDump(tile) {
        // Omnidirectional bridges dump items to all directions
        return true;
    },
